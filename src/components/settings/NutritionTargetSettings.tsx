...
export function NutritionTargetSettings() {
  ...
  const TargetFields = ({ prefix }: { prefix: "weekday" | "weekend" }) => {
    ...
    const macroMode = isWeekend ? weekendMacroInputMode : weekdayMacroInputMode;
    const setMacroMode = isWeekend ? setWeekendMacroInputMode : setWeekdayMacroInputMode;
    const split = isWeekend ? weekendMacroSplit : weekdayMacroSplit;
    const setSplit = isWeekend ? setWeekendMacroSplit : setWeekdayMacroSplit;
